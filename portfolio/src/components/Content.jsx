...
import Particles from './icons/Particles';
import styled from 'styled-components';
function Content()
{
   
   return(
      <main className="min-h-screen text-white px-6 py-12 bg-black">
         <Particles
...
/>
         ...
         <img src={MyPhoto} alt="Profile" className="rounded-lg shadow-lg max-w-4xl min-w-2xs px-7 py-13  z-10 max-h-3xl min-h-4xs " />
         <div className="text-left p-20  ml-10 text-2xl px-6 py-12 backdrop-blur-sm min-w-3xs max-w-full">
